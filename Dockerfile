...
# Repositories
RUN mvn -U org.apache.maven.plugins:maven-dependency-plugin:3.0.1:copy -Dartifact=org.sonatype.nexus.plugins:nexus-repository-apk:0.0.21 -DoutputDirectory=/nexus
...
RUN mvn -U org.apache.maven.plugins:maven-dependency-plugin:3.0.1:copy -Dartifact=org.sonatype.nexus.plugins:nexus-repository-composer:0.0.18 -DoutputDirectory=/nexus
